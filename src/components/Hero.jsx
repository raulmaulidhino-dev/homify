const Hero = () => {
    return (
        <section id="hero" className="w-full px-5 py-12 md:px-10">
            <h1 className="mx-auto mb-5 text-3xl sm:text-4xl md:text-5xl lg:text-6xl md:leading-tight lg:leading-snug sm:text-center font-extrabold max-w-5xl">Elevate Your Home Experiences with Cutting-edge <span className="bg-gradient-to-r from-fuchsia-600 to-purple-600 bg-clip-text text-transparent">Smart Technology</span> from Homify</h1>
