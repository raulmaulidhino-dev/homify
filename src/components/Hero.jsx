    ...
    return (
        <section id="hero" className="w-full px-5 py-12 md:px-10">
            <h1 className="mx-auto mb-5 text-3xl sm:text-4xl md:text-5xl lg:text-6xl md:leading-tight lg:leading-snug sm:text-center font-extrabold max-w-5xl relative">
                ...
                <img className="w-24 absolute top-[-2rem] left-[2rem] md:left-[-2rem] z-30 hidden md:block" src={ CCTV } alt="CCTV" />
                <img className="w-20 absolute bottom-[-3rem] right-[1rem] md:right-[-3rem] z-30 hidden md:block" src={ LightBulb } alt="Light Bulb" />
            </h1>
