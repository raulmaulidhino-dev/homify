    ...
    return (
        <section id="manage_your_home" className="w-full px-10 py-[6rem] flex flex-wrap justify-center items-center content-center gap-4">
            ...
            <section>
                ...
                <p className="text-sm sm:text-md md:text-lg lg:text-xl max-w-sm mb-[1em]">Manage your entire smart home from one intuitive app whether it"s adjusting the lights, setting the temperature, or checking security cameras, Homify puts complete control of your home in the palm of your hand.</p>
